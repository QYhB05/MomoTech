...
public class MomotechItem {
    ...
    public static SlimefunItemStack commandBlock = new SlimefunItemStack("COMMAND_BLOCK_GETTER", Items.COMMAND_BLOCK_GETTER);
    public static SlimefunItemStack creative__ = new SlimefunItemStack("CREATIVE__", Items.CREATIVE__);
    public static SlimefunItemStack cobblestone_generator = new SlimefunItemStack("STONE_GENERATOR_I", Items.STONE_GENERATOR_I);
    ...
    public static SlimefunItemStack transporter = new SlimefunItemStack("MOMOTECH_TRANSPORTER", Items.MOMOTECH_TRANSPORTER);
    public static SlimefunItemStack shine = new SlimefunItemStack("MOMOTECH_SHINE", Items.MOMOTECH_SHINE);
    public static SlimefunItemStack dark = new SlimefunItemStack("MOMOTECH_DARK", Items.MOMOTECH_DARK);
    public static SlimefunItemStack shine1 = new SlimefunItemStack("MOMOTECH_SHINE1", Items.MOMOTECH_SHINE1);
    public static SlimefunItemStack dark1 = new SlimefunItemStack("MOMOTECH_DARK1", Items.MOMOTECH_DARK1);
    public static SlimefunItemStack shine_and_dark_constructor = new SlimefunItemStack("MOMOTECH_SHINE_AND_DARK_CONSTRUCTOR", Items.MOMOTECH_SHINE_AND_DARK_CONSTRUCTOR);
    public static SlimefunItemStack iron_star = new SlimefunItemStack("MOMOTECH_IRON_STAR", Items.MOMOTECH_IRON_STAR);
    public static SlimefunItemStack constructor = new SlimefunItemStack("MOMOTECH_CONSTRUCTOR", Items.MOMOTECH_CONSTRUCTOR);
    public static SlimefunItemStack diamond = new SlimefunItemStack("MOMOTECH_DIAMOND", Items.MOMOTECH_DIAMOND);
    public static SlimefunItemStack quartz = new SlimefunItemStack("MOMOTECH_QUARTZ", Items.MOMOTECH_QUARTZ);
    public static SlimefunItemStack iron = new SlimefunItemStack("MOMOTECH_IRON", Items.MOMOTECH_IRON);
    public static SlimefunItemStack gold = new SlimefunItemStack("MOMOTECH_GOLD", Items.MOMOTECH_GOLD);
    public static SlimefunItemStack lapis = new SlimefunItemStack("MOMOTECH_LAPIS", Items.MOMOTECH_LAPIS);
    public static SlimefunItemStack redstone = new SlimefunItemStack("MOMOTECH_REDSTONE", Items.MOMOTECH_REDSTONE);
    public static SlimefunItemStack emerald = new SlimefunItemStack("MOMOTECH_EMERALD", Items.MOMOTECH_EMERALD);
    public static SlimefunItemStack coal = new SlimefunItemStack("MOMOTECH_NETHERITE", Items.MOMOTECH_COAL);
    public static SlimefunItemStack cu = new SlimefunItemStack("MOMOTECH_CU", Items.MOMOTECH_Cu);
    public static SlimefunItemStack pb = new SlimefunItemStack("MOMOTECH_PB", Items.MOMOTECH_Pb);
    public static SlimefunItemStack mg = new SlimefunItemStack("MOMOTECH_MG", Items.MOMOTECH_Mg);
    public static SlimefunItemStack au = new SlimefunItemStack("MOMOTECH_AU", Items.MOMOTECH_Au);
    public static SlimefunItemStack al = new SlimefunItemStack("MOMOTECH_AL", Items.MOMOTECH_Al);
    public static SlimefunItemStack sn = new SlimefunItemStack("MOMOTECH_SN", Items.MOMOTECH_Sn);
    public static SlimefunItemStack zn = new SlimefunItemStack("MOMOTECH_ZN", Items.MOMOTECH_Zn);
    public static SlimefunItemStack ag = new SlimefunItemStack("MOMOTECH_AG", Items.MOMOTECH_Ag);
    public static SlimefunItemStack diamond1 = new SlimefunItemStack("MOMOTECH_DIAMOND1", Items.MOMOTECH_DIAMOND1);
    public static SlimefunItemStack quartz1 = new SlimefunItemStack("MOMOTECH_QUARTZ1", Items.MOMOTECH_QUARTZ1);
    public static SlimefunItemStack iron1 = new SlimefunItemStack("MOMOTECH_IRON1", Items.MOMOTECH_IRON1);
    public static SlimefunItemStack gold1 = new SlimefunItemStack("MOMOTECH_GOLD1", Items.MOMOTECH_GOLD1);
    public static SlimefunItemStack lapis1 = new SlimefunItemStack("MOMOTECH_LAPIS1", Items.MOMOTECH_LAPIS1);
    public static SlimefunItemStack redstone1 = new SlimefunItemStack("MOMOTECH_REDSTONE1", Items.MOMOTECH_REDSTONE1);
    public static SlimefunItemStack emerald1 = new SlimefunItemStack("MOMOTECH_EMERALD1", Items.MOMOTECH_EMERALD1);
    public static SlimefunItemStack coal1 = new SlimefunItemStack("MOMOTECH_NETHERITE1", Items.MOMOTECH_COAL1);
    public static SlimefunItemStack cu1 = new SlimefunItemStack("MOMOTECH_CU1", Items.MOMOTECH_Cu1);
    public static SlimefunItemStack pb1 = new SlimefunItemStack("MOMOTECH_PB1", Items.MOMOTECH_Pb1);
    public static SlimefunItemStack mg1 = new SlimefunItemStack("MOMOTECH_MG1", Items.MOMOTECH_Mg1);
    public static SlimefunItemStack au1 = new SlimefunItemStack("MOMOTECH_AU1", Items.MOMOTECH_Au1);
    public static SlimefunItemStack al1 = new SlimefunItemStack("MOMOTECH_AL1", Items.MOMOTECH_Al1);
    public static SlimefunItemStack sn1 = new SlimefunItemStack("MOMOTECH_SN1", Items.MOMOTECH_Sn1);
    public static SlimefunItemStack zn1 = new SlimefunItemStack("MOMOTECH_ZN1", Items.MOMOTECH_Zn1);
    public static SlimefunItemStack ag1 = new SlimefunItemStack("MOMOTECH_AG1", Items.MOMOTECH_Ag1);
    public static SlimefunItemStack real_magnet = new SlimefunItemStack("MOMOTECH_REAL_MAGNET", Items.MOMOTECH_REAL_MAGNET);
    public static SlimefunItemStack coil = new SlimefunItemStack("MOMOTECH_COIL", Items.MOMOTECH_COIL);
    public static SlimefunItemStack electricity_magnet = new SlimefunItemStack("MOMOTECH_ELECTRICITY_MAGNET", Items.MOMOTECH_ELECTRICITY_MAGNET);
    public static SlimefunItemStack infinity = new SlimefunItemStack("MOMOTECH_INFINITY", Items.MOMOTECH_INFINITY);
    public static SlimefunItemStack magnetize = new SlimefunItemStack("MOMOTECH_MAGNETIZE", Items.MOMOTECH_MAGNETIZE);
    public static SlimefunItemStack mineral__ = new SlimefunItemStack("MOMOTECH_MINERAL_", Items.MOMOTECH_MINERAL_);
    public static SlimefunItemStack metal__ = new SlimefunItemStack("MOMOTECH_METAL_", Items.MOMOTECH_METAL_);
