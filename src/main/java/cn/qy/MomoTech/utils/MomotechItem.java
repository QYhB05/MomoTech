...
public class MomotechItem {
    ...
    */
    ...
    public static final SlimefunItemStack quantum_ = new SlimefunItemStack("MOMOTECH_QUANTUM" + MomoTech.seed, Items.MOMOTECH_QUANTUM);
    public static final SlimefunItemStack quantum1_ = new SlimefunItemStack("MOMOTECH_QUANTUM1" + MomoTech.seed, Items.MOMOTECH_QUANTUM1);
    ...
    public static SlimefunItemStack none_ = new SlimefunItemStack("MOMOTECH_NONE" + MomoTech.seed, Items.MOMOTECH_NONE);
    ...
    public static SlimefunItemStack qy = new SlimefunItemStack("QY" + MomoTech.seed, Items.QY);
    public static SlimefunItemStack ch = new SlimefunItemStack("CH" + MomoTech.seed, Items.wbx);
