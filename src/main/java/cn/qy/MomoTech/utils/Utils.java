...
public class Utils {
    ...
    public static List getLore(ItemMeta meta) {
        ...
        return (List) (lore == null ? new ArrayList() : lore);
    }
    ...
    public static boolean checkCombinator(ItemStack it) {
        ...
        if (SlimefunUtils.isItemSimilar(it, Items.MOMOTECH_DIGITAL, false, false)) return true;
        return false;
    }

    public static String replaceSpace(String text) {
        return text.indexOf(34) == -1 ? text : text.replace("\"\"", " ");
    }
}
