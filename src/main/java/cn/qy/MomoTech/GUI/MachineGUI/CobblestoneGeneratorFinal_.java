...
public abstract class CobblestoneGeneratorFinal_ extends AbstractGUI {
    protected CobblestoneGeneratorFinal_(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
