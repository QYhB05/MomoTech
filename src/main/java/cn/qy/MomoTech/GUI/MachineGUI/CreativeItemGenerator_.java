...
public abstract class CreativeItemGenerator_ extends AbstractGUI {
    protected CreativeItemGenerator_(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected MachineRecipe findNextRecipe(BlockMenu inv) {
        for (int i : getInputSlots()) if (inv.getItemInSlot(i) == null) return null;
