...
public class Register {
    ...
    public static void run() {
        add(new ItemStack[]{QUANTITY_ITEM, FROG_LIGHT_GENERATOR, STONE_GENERATOR, ORE_GENERATOR, SAND_GENERATOR,
                ...
                MOMOTECH_RULE_U_GENERATOR, MOMOTECH_RULE_GEO, MOMOTECH_RULE_REACTOR, MOMOTECH_MINERAL_GENERATOR, MOMOTECH_MINERAL_BLOCK_GENERATOR,
                MOMOTECH_PLANT, MOMOTECH_WOOD, LINE_GENERATOR, MOMOTECH_RULE_SHINE_AND_DARK_CONSTRUCTOR, MOMOTECH_ENERGY_QUANTUM, MOMOTECH_RANDOM_QUANTUM, MOMOTECH_RANDOM_QUANTUM_GENERATOR, MOMOTECH_FINAL_RULE, MOMOTECH_RESOURCE, MOMOTECH_ENERGY_INGOT,
                MOMOTECH_COMMAND_BLOCK1, MOMOTECH_COMMAND_BLOCK2, MOMOTECH_COMMAND_BLOCK3, MOMOTECH_RULE_ITEM, MOMOTECH_FINAL_CAPITAL, MOMOTECH_FINAL_GENERATOR, MOMOTECH_FINAL_ELECTRIC_EATER, MOMOTECH_FOREVER, MOMOTECH_ETERNAL_MINING_MACHINE, MOMOTECH_FOREVER_
        });
    }
}
