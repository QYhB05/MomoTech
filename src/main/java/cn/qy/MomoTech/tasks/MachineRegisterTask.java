...
public class MachineRegisterTask {
    public static void run(@NotNull Logger logger) {
        ...
        ItemStack[] ordinaryNumberCombinator = {
                quantum_, new SlimefunItemStack("MOMOTECH_PROTON", Items.MOMOTECH_PROTON), quantum1_,
        ...
        ItemStack[] symbolGenerator = {
                ...
                new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER), creative_item, new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER),
        ...
        ItemStack[] constructor = {
                ...
                qy, new SlimefunItemStack("MOMOTECH_PROTON", Items.MOMOTECH_PROTON), ch,
        ...
        ItemStack[] magnetGenerator = {
                uncontrollable_empty, new SlimefunItemStack("MOMOTECH_PROTON", Items.MOMOTECH_PROTON), uncontrollable_empty,
        ...
        ItemStack[] eternalMiningMachine = {
                ...
                quantum1_, SlimefunItems.GPS_TRANSMITTER_4, new SlimefunItemStack("MOMOTECH_RANDOM_QUANTUM", Items.MOMOTECH_RANDOM_QUANTUM),
                new SlimefunItemStack("MOMOTECH_RANDOM_QUANTUM", Items.MOMOTECH_RANDOM_QUANTUM), new SlimefunItemStack("MOMOTECH_RANDOM_QUANTUM", Items.MOMOTECH_RANDOM_QUANTUM), new SlimefunItemStack("MOMOTECH_RANDOM_QUANTUM", Items.MOMOTECH_RANDOM_QUANTUM)
        };
        ...
        ItemStack[] digitalGenerator = {
                new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER), new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER), new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER),
                new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER), bug_crystal, new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER),
                new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER), new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER), new SlimefunItemStack("MOMOTECH_FOREVER", Items.MOMOTECH_FOREVER)
        };
        ItemStack[] compressor = {
                new SlimefunItemStack("MOMOTECH_FOREVER_", Items.MOMOTECH_FOREVER), quantum1_, new SlimefunItemStack("MOMOTECH_FOREVER_", Items.MOMOTECH_FOREVER),
                uncontrollable_empty, SlimefunItems.COMPRESSOR, uncontrollable_empty,
