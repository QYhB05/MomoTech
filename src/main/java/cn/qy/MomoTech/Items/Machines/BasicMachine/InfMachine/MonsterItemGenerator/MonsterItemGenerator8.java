...
public class MonsterItemGenerator8 extends MonsterItemGenerator implements RecipeDisplayItem {
    private final Material[] it = {Material.BLAZE_POWDER, Material.BLAZE_ROD};

    public MonsterItemGenerator8(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public @NotNull String getMachineIdentifier() {
        return "MOMOTECH_MONSTER_GENERATOR8";
    }
