...
import static cn.qy.MomoTech.Items.MomotechItem.electricity_magnet;
import static cn.qy.MomoTech.Items.MomotechItem.real_magnet;
...
public class MagnetGenerator extends AContainer implements RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        displayRecipes.add(electricity_magnet.clone());
