...
public class EntropyReconstruct extends AContainer implements RecipeDisplayItem {
    public EntropyReconstruct(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    private MachineRecipe get(Material it1, Material it2) {
        return new MachineRecipe(180, new ItemStack[]{new ItemStack(it1)}, new ItemStack[]{new ItemStack(it2)});
    }
    @Override
    protected void registerDefaultRecipes() {
        this.registerRecipe(get(Material.COAL, Material.IRON_INGOT));
        this.registerRecipe(get(Material.IRON_INGOT, Material.GOLD_INGOT));
        this.registerRecipe(get(Material.GOLD_INGOT, Material.DIAMOND));
        this.registerRecipe(get(Material.DIAMOND, Material.NETHERITE_INGOT));
