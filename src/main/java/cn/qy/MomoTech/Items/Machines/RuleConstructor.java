...
public class RuleConstructor extends AContainer implements RecipeDisplayItem {
    public RuleConstructor(ItemGroup itemGroup, String id, ItemStack it, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected void registerDefaultRecipes() {
        this.registerRecipe(1, new SlimefunItemStack(infinity, 32), rule_star);
        this.registerRecipe(1, new SlimefunItemStack(shine, 64), MomotechItem.shine1);
        this.registerRecipe(1, new SlimefunItemStack(dark, 64), MomotechItem.dark1);
        this.registerRecipe(1, new ItemStack(Material.DIAMOND, 64), diamond);
        this.registerRecipe(1, new ItemStack(Material.IRON_INGOT, 64), iron);
        this.registerRecipe(1, new ItemStack(Material.GOLD_INGOT, 64), gold);
        this.registerRecipe(1, new ItemStack(Material.REDSTONE, 64), redstone);
        this.registerRecipe(1, new ItemStack(Material.LAPIS_LAZULI, 64), lapis);
        this.registerRecipe(1, new ItemStack(Material.QUARTZ, 64), quartz);
        this.registerRecipe(1, new ItemStack(Material.COAL, 64), coal);
        this.registerRecipe(1, new ItemStack(Material.EMERALD, 64), emerald);
        this.registerRecipe(1, new SlimefunItemStack(diamond, 64), diamond1);
        this.registerRecipe(1, new SlimefunItemStack(iron, 64), iron1);
        this.registerRecipe(1, new SlimefunItemStack(gold, 64), gold1);
        this.registerRecipe(1, new SlimefunItemStack(redstone, 64), redstone1);
        this.registerRecipe(1, new SlimefunItemStack(lapis, 64), lapis1);
        this.registerRecipe(1, new SlimefunItemStack(quartz, 64), quartz1);
        this.registerRecipe(1, new SlimefunItemStack(coal, 64), coal1);
        this.registerRecipe(1, new SlimefunItemStack(emerald, 64), emerald1);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.SILVER_INGOT, 64), ag);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.COPPER_INGOT, 64), cu);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.GOLD_4K, 64), au);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.LEAD_INGOT, 64), pb);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.TIN_INGOT, 64), sn);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.ZINC_INGOT, 64), zn);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.MAGNESIUM_INGOT, 64), mg);
        this.registerRecipe(1, new SlimefunItemStack(SlimefunItems.ALUMINUM_INGOT, 64), al);
        this.registerRecipe(1, new SlimefunItemStack(ag, 64), ag1);
        this.registerRecipe(1, new SlimefunItemStack(cu, 64), cu1);
        this.registerRecipe(1, new SlimefunItemStack(au, 64), au1);
        this.registerRecipe(1, new SlimefunItemStack(pb, 64), pb1);
        this.registerRecipe(1, new SlimefunItemStack(sn, 64), sn1);
        this.registerRecipe(1, new SlimefunItemStack(zn, 64), zn1);
        this.registerRecipe(1, new SlimefunItemStack(mg, 64), mg1);
        this.registerRecipe(1, new SlimefunItemStack(al, 64), al1);
