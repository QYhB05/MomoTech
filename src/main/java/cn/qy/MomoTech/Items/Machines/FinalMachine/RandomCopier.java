...
public class RandomCopier extends AbstractGUI implements RecipeDisplayItem {
    ...
    protected BlockBreakHandler onBlockBreak() {
        return new SimpleBlockBreakHandler() {
            public void onBlockBreak(@NotNull Block b) {
                ...
                if (inv != null) {
                    for (int i = 0; i <= 53; ++i) {
                        if (i == 51 || i == 53 || i == 36 || i == 37 || i == 38 || i == 40 || i == 41 || i == 42 || i == 43 || i == 44 || i == 45 || i == 46 || i == 47 || i == 48 || i == 39 || i == 50) {
                            continue;
                        }
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, "&f左下角输入原始物质γ有5%概率随机复制上方交互槽中的一种物品", "&7要求:交互槽种物品数量种类均不相等"));
        return it;
    }
}
