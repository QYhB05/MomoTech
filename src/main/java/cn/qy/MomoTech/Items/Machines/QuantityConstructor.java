...
public class QuantityConstructor extends AbstractGUI implements RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, "&f制作原始物质γ", "&f要求:输入槽填满64堆叠的不可控空后有50%概率生成"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(uncontrollable_empty);
        it.add(creative_item_II);
        it.add(new CustomItemStack(Material.BOOK, "&f制作BUG水晶", "&f要求:输入槽填满64堆叠物品且同时使用6种BUG物质制作"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(bug);
        it.add(bug_crystal);
        it.add(bug1);
        ...
        it.add(bug5);
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(new CustomItemStack(Material.BOOK, "&f制作纯净的始源", "&f要求:输入槽填满64堆叠物品并且同时使用原始物质α和β"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(creative_item_I);
        it.add(creative__);
        it.add(creative_item);
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(new CustomItemStack(Material.BOOK, "&f制作乱码核心", "&f要求:输入槽填满64堆叠的终极之心后有50%概率生成"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        it.add(final_star);
        it.add(final_item);
        it.add(new CustomItemStack(Material.BOOK, "&f制作量化插件", "&f要求:输入槽填满64堆叠的任意物品后有0.05%概率生成"));
        it.add(quantity_item);
        return it;
    }
}
