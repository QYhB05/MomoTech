...
public class QuantityConstructor extends AbstractGUI implements RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        it.add(new CustomItemStack(Material.BOOK, "&f制作创世命令方块 - COMMON", "&f要求:输入槽存在45x64个命令方块后生成"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        ...
        it.add(new CustomItemStack(Material.BOOK, "&f制作创世命令方块 - REPEATING", "&f要求:输入槽存在45x64个循环命令方块后生成"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        ...
        it.add(new CustomItemStack(Material.BOOK, "&f制作创世命令方块 - COMMON", "&f要求:输入槽存在45x64个脉冲命令方块后生成"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
        ...
        it.add(new CustomItemStack(Material.BOOK, "&f概念物", "&f要求:输入槽存在45x64个Resource后生成"));
        it.add(new CustomItemStack(Material.GRAY_STAINED_GLASS_PANE, " "));
