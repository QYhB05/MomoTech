...
public class Items {
    ...
    public static ItemStack MOMOTECH_FINAL_STAR = new CustomItemStack(Material.HONEYCOMB, "&c&l终&e&l极&b&l之&e&l心", "&7凝聚于此");
    ...
    public static ItemStack MOMOTECH_FINAL_COPIER = new CustomItemStack(Material.DEEPSLATE_GOLD_ORE, "&6&l复刻鸡 - 终极", "&c整合粒子!", "&7中间放入目标物品,左边放入§8§l§k123&f&l不可控空&7立马复制出一个目标物品");
    ...
    public static ItemGroup MOMOTECH_PHISICS;
    ...
    static {
        ...
        ItemStack[] GROUP = {new CustomItemStack(Material.PAPER, "&c&l注意", "&b&l附属机器非注明不需要电力", "&b&l所有机器只有在输出槽有空位的时候才会工作"),
                ...
                new CustomItemStack(Material.BLACK_CONCRETE_POWDER, "§8§l基础机器"), new CustomItemStack(Material.GOLD_BLOCK, "§6§l高级矿物"),
                ...
                new CustomItemStack(Material.BLAZE_POWDER, "&a&l物理工程(待完善)")};
        Register.add(GROUP);
        ...
        MOMOTECH_PHISICS = new SubGroup("MOMOTECH_PHISICS",GROUP[9]);
        MOMOTECH = new MultiGroup("MOMOTECH",GROUP[8], MOMOTECH__, MOMOTECH_ITEM, MOMOTECH_TOOL, MOMOTECH_MINERAL, MOMOTECH_ORDINARY_MACHINE, MOMOTECH_MACHINE, MOMOTECH_PHISICS, MOMOTECH_FINAL, MOMOTECH_THANKING);
