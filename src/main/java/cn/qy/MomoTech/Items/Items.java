...
public class Items {
    ...
    public static ItemStack MOMOTECH_EXP = new CustomItemStack(Material.EXPERIENCE_BOTTLE, "&6经验 经验 更多经验", "&7扔出后经验立马提升10级");
    ...
    public static ItemStack ELSE_ = new CustomItemStack(Material.PAPER, "&f特性:电力反制", "&7部分电力机器在无输入的时候也会持续消耗电力");
    public static ItemStack ELSE_1 = new CustomItemStack(Material.PAPER, "&f特性:无电力", "&7所有非注明用电的机器均不消耗电力(但机器本身都会存储1J)");
    public static ItemStack ELSE_2 = new CustomItemStack(Material.PAPER, "&f特性:槽位仅空", "&7部分机器只有在输出槽有空位时才会工作");
    public static ItemStack ELSE_3 = new CustomItemStack(Material.PAPER, "&f特性:Bug - 日期", "&7如果你的计算器计算结果等于日期并且没有输出Bug - 日期, 或许你可以试试再给那个数字组件+0");
    ...
    public static ItemStack MOMOTECH_FINAL_RULE = new CustomItemStack(Material.BONE_MEAL, "&3概&b念&a物");
    public static ItemStack MOMOTECH_ENERGY_INGOT = new CustomItemStack(Material.NETHERITE_INGOT, "&6放射性充能锭");
    public static ItemStack MOMOTECH_RESOURCE = new CustomItemStack(Material.COMMAND_BLOCK, "&a&lResource", "&7大力支持本附属并且进行了大量宣传");
    public static ItemStack MOMOTECH_COMMAND_BLOCK1 = new CustomItemStack(Material.COMMAND_BLOCK, "&6创世命令方块 - COMMON");
    public static ItemStack MOMOTECH_COMMAND_BLOCK2 = new CustomItemStack(Material.REPEATING_COMMAND_BLOCK, "&6创世命令方块 - REPEATING");
    public static ItemStack MOMOTECH_COMMAND_BLOCK3 = new CustomItemStack(Material.CHAIN_COMMAND_BLOCK, "&6创世命令方块 - CHAIN");
    public static ItemStack MOMOTECH_RULE_ITEM = new CustomItemStack(Material.REDSTONE_TORCH, "&c&l创世齿轮");
    public static ItemStack MOMOTECH_EFFECT_DELETER = new CustomItemStack(Material.IRON_INGOT, "&f状态化清除器", "&7右键清除药水效果");
    public static ItemStack MOMOTECH_THROW = new CustomItemStack(Material.IRON_INGOT, "&f背包丢出器", "&7右键丢出所有物品(包括盔甲)");
    ...
    public static ItemStack MOMOTECH_MONSTER_ITEM7 = new CustomItemStack(Material.BLACK_STAINED_GLASS, "&7史莱姆农场模拟器", "&7效率:32x", "§8⇨ §e⚡ §715,000 J/t");
    public static ItemStack MOMOTECH_MONSTER_ITEM8 = new CustomItemStack(Material.BLACK_STAINED_GLASS, "&7烈焰人农场模拟器", "&7效率:32x", "§8⇨ §e⚡ §715,000 J/t");
    public static ItemStack MOMOTECH_MONSTER_ITEM9 = new CustomItemStack(Material.BLACK_STAINED_GLASS, "&7岩浆怪农场模拟器", "&7效率:32x", "§8⇨ §e⚡ §715,000 J/t");
    ...
    public static ItemStack MOMOTECH_PLANT = new CustomItemStack(Material.CHISELED_DEEPSLATE, "&f植物培养器", "&7插入植物种子或者是类似于睡莲, 藤蔓, 草等物品", "&7效率:32x", "§8⇨ §e⚡ §710,000 J/t");
    public static ItemStack MOMOTECH_WOOD = new CustomItemStack(Material.CHISELED_DEEPSLATE, "&f树木培养器", "&7插入树苗或者下届菌类", "&7效率:32x", "§8⇨ §e⚡ §710,000 J/t");
    public static ItemStack MOMOTECH_ENERGY_QUANTUM = new CustomItemStack(Material.SLIME_BALL, "&c高&e能&b量&a子", "&7危险, 高能!");
    public static ItemStack MOMOTECH_RANDOM_QUANTUM = new CustomItemStack(Material.CLAY_BALL, "&e随&b机&a量&3子", "&7随机~", "&7右键会死掉");
    public static ItemStack MOMOTECH_RANDOM_QUANTUM_GENERATOR = new CustomItemStack(Material.GRAY_WOOL, "&e随机量子发生器");
    public static ItemStack MOMOTECH_ENERGY_QUANTUM_GENERATOR = new CustomItemStack(Material.WHITE_WOOL, "&a量子充能器", "§8⇨ §e⚡ &7500,000,000 J/t");
    ...
    public static ItemStack MOMOTECH_PERCENT_GENERATOR = new CustomItemStack(Material.BAMBOO_FENCE, "&a百分比发电桩", "&7为上方机器每tick提供储电上限x10%的电量");
