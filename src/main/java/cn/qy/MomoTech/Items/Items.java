...
public class Items {
    ...
    public static ItemStack MOMOTECH_NONE = new CustomItemStack(new ItemStack(Material.BLACK_WOOL), "§8§lNONE", "§0一片虚无", "&8&l消逝物质 : 因为某些原因这种物质和服务器粒子纠缠, 每一次重启都会失效...", "&8&lseed:" + MomoTech.seed);
    ...
    public static ItemStack wbx = new CustomItemStack(new ItemStack(Material.COMMAND_BLOCK), "&e&lChenmose", "&7可爱捏~", "&7提供了一些主意, 是附属创始者之一", "&8&l我是不会告诉你他前期之后摆烂了", "&8QQ:1910428053", "&8&l消逝物质 : 因为某些原因这种物质和服务器粒子纠缠, 每一次重启都会失效...", "&8&lseed:" + MomoTech.seed);
    ...
    public static ItemStack MOMOTECH_QUANTUM = new CustomItemStack(Material.SNOWBALL, "&e量&6子", "&f机制:使用之后会立即死亡, 触发特定条件可以获得纠缠量子, 但会清除背包", "&8&l消逝物质 : 因为某些原因这种物质和服务器粒子纠缠, 每一次重启都会失效...", "&8&lseed:" + MomoTech.seed);
    public static ItemStack MOMOTECH_QUANTUM1 = new CustomItemStack(Material.MAGMA_CREAM, "&a纠&b缠&e量&6子", "&f随量子而纠缠的粒子, 右键貌似也会发生一些不好的事情", "&f用于高精密的高速通讯机器", "&8&l消逝物质 : 因为某些原因这种物质和服务器粒子纠缠, 每一次重启都会失效...", "&8&lseed:" + MomoTech.seed);
