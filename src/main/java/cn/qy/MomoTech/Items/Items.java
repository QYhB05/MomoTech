...
public class Items {
    ...
    public static ItemStack FINAL_C_ = new CustomItemStack(Material.COBBLESTONE, "&6&l100重压缩圆石生成器", "&7&l正确的, 你没听错", "&f谁知道呢 或许有点用处呢", "&7效率:8x");
    ...
    public static ItemStack MOMOTECH_WOOD = new CustomItemStack(Material.OAK_LOG, "&f树木培养器", "§8⇨ §e⚡ §7100 J/t");
    ...
    static {
        ...
        ItemStack[] GROUP = {new CustomItemStack(Material.PAPER, "&c&l注意", "&b&l附属机器非注明不需要电力", "&b&l所有机器只有在输出槽有空位的时候才会工作"),
                ...
                new CustomItemStack(Material.BLAZE_POWDER, "&a&l拓展 - 无限工程(待完善)"), new CustomItemStack(Material.SEA_PICKLE, "&b&l电力拓展")};
        Register.add(GROUP);
        ...
        MOMOTECH = new MultiGroup("MOMOTECH", GROUP[8], MOMOTECH__, MOMOTECH_THANKING, MOMOTECH_ITEM, MOMOTECH_MINERAL, MOMOTECH_TOOL, MOMOTECH_ORDINARY_MACHINE, MOMOTECH_MACHINE, MOMOTECH_FINAL, MOMOTECH_ELECTRICITY, MOMOTECH_INF);
